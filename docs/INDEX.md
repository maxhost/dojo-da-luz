...
| [0045](specs/0045-lanzamiento-dominio-301-sitemap.md) | 2026-09-21 | Los 301 de las 38 URLs del Wix, el `sitemap.xml` generado del contenido y el cambio de dominio | cerrada | si | `astro.config.mjs`, `src/lib/redirects*.ts`, `src/pages/sitemap.xml.ts`, `public/robots.txt` |
...
| [0048](specs/0048-accesibilidad-e-idioma.md) | 2026-09-21 | Los dos `aria-label` del navbar traducidos y los nombres de idioma con acentos | cerrada | si | `src/lib/i18n.ts`, `src/layouts/Base.astro` |
