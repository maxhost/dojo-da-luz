...
| [0048](adr/0048-foco-por-imagen.md) | 2026-09-25 | Las imagenes en riesgo de recorte mal encuadrado guardan un punto focal (object-position) elegido con un clic, no un recorte real | aceptada | `docs/adr/0048-foco-por-imagen.md` |
...
| [0052](specs/0052-foco-de-imagen-en-eventos.md) | 2026-09-25 | Cada evento de /eventos gana un punto focal opcional para su foto, elegido con un clic; sin foco, el recorte sigue centrado como hoy | **cerrada** | no | `src/lib/{schemas,traduccion,eventos-edicion}.ts`, `src/components/admin/{TablaFilas,CampoFoco,FormularioEventos}.astro`, `src/components/EventsView.astro`, `content/*/events.json` |
